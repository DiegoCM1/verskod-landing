  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        data-aos-delay={200}
      >
        <figure className="relative overflow-hidden rounded-2xl before:absolute before:inset-0 before:-z-10 before:bg-linear-to-br before:from-gray-900 before:via-button-primary/20 before:to-gray-900">
          <Image
